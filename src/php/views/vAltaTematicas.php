<div class="tematicas">
    <form action="index.php?c=cTematicas&m=altaTematicas" enctype="multipart/form-data" method="post">
        ...
        <table>
            ...
            <tr>
                <td><input type="hidden" id="ambito_0" name="ambito_0" value="1">Participación Democrática</td>
            ...
            <tr>
                <td><input type="hidden" id="ambito_1" name="ambito_1" value="2">Justicia Social</td>
            ...
            <tr>
                <td><input type="hidden" id="ambito_2" name="ambito_2" value="3">Desarrollo Humano y Sostenible</td>
            ...
            <tr>
                <td><input type="hidden" id="ambito_3" name="ambito_3" value="4">Interculturalidad e Inclusion</td>
            ...
            <tr>
                <td><input type="hidden" id="ambito_4" name="ambito_4" value="5">Equidad de genero y Coeducacion</td>
